...
<!------------------ admin  patient details table section starts------------------------->
<div class="row"> 
...
<table class="container-fluid table">
    ...
    <?php 
      ...
      <tr>
        ...
        <td><a href="admin_patient_profile.php?id=<?php echo $row['pid']?>" class="btn btn-outline-secondary  btn-arrow-right" role="button">More ></a></td></td>   
        </tr>
        <?php 
					  }
					  ?>
...
<!------------------ admin  patient details table ends------------------------->
<!----------------------------------------Footer Starts------------------------>  
