...
<section >
					...
					<div class="col-md-12 mt-5">
						<table class="border table table-striped bg-table">
							...
							<th class="text-right"><a href="admin_doctor_profile_edit.php?id=<?php echo $row['did'];?>"><button   class="btn btn-primary text-white px-4">Edit<i class="fas  fa-edit"></i></button></a>
							</th>
							</tr>
