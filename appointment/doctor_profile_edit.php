                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="php_doctor_profile_update.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="email_address" class="form-control box-bg" name="name" value="<?php echo $row['dname']; ?>">
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="address" value="<?php echo $row['daddress']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="date"  class="form-control box-bg" name="dob" value="<?php echo $row['ddob']; ?>">
                                    </div>
                                </div>
								...
								<div class="form-group row">
								 ...
								 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  name="email" class="form-control box-bg" value="<?php echo $row['demail']; ?>">
                                    </div>
                                </div>
...
<script>
 ...
 <!------------------ doctor profile edit section ends------------------------->
