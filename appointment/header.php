        ...
        <div class="col-md-11">
            ...
            <div class="col-md-1 navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown ml-5">
                    <a class="nav-link dropdown-toggle btn btn-outline-secondary ml-5 my-2 pl-2 pr-2" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Doctors
                    </a>
                ...
                <a href=""><button class="btn btn-outline-secondary my-2 p-2 pl-3 pr-3" type="submit">Patients</button></a>
                </li>
                <li class="nav-item ml-5">
                <a href="php_logout.php"><button class="btn btn-outline-secondary ml-4 my-2 p-2 pl-4 pr-4" type="submit">Logout</button></a>
                </li>
                </ul>
            </div>
        </div>
